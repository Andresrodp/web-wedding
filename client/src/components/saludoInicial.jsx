...
const SaludoInicial = ({ nombre }) => {
  return (
    <div className="w-full h-96 flex flex-col items-center p-2 bg-none shadow-sm shadow-quaternary bg-opacity-50 rounded-md">
      <h1 className="text-quinary text-lg font-bold font-serif m-4">Hola {nombre}</h1>
