...
const Regalos = () => {
  return (
    <section className="flex flex-col items-center w-full rounded-md shadow-sm shadow-quaternary bg-none px-2 py-4 font-serif text-quinary mb-6">
      <h1 className="text-lg font-bold">Regalos</h1>
      <h2 className="font-semibold">Lluvia de Sobres</h2>
      <br />
